...
import ProductPreview from "../component/product-preview";
...
const HomePage = () => {
    ...
    const loadLatestProduct = () => {
        const url = "https://shop143.onrender.com/telebuy/api/products/latest";
    ...
    const loadRecentProduct = () => {
        const url = "https://shop143.onrender.com/telebuy/api/product/preview";
        ...
        <Slide>
              <div className="each-slide-effect">
                  <div style={{ 'backgroundImage': `url(${images[0]})` }}>
                    <div className="caption-group text-left">
